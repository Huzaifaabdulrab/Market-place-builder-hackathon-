...
//             <span className="text-[14px] text-gray-500">Apply promo code {product.product_id}</span>
...
//             <span className="lg:text-[20px] text-[16px]  mt-3 lg:mr-28 font-semibold text-black">
//               Total Rental Price + discount
//             </span>
//             <span className="lg:text-[32px] text-[20px] font-bold text-black">${product.discount}</span>
//           </div>
